...
`### Retro (YYYY-MM-DD — <window>)`. Commit per the journal convention:
`Journal YYYY-MM-DD: retro — <summary>`, brief body, attribution per
config. PLAN edits the retro proposes are listed for the user to apply
