...
- Working tree clean; `scripts/check.sh` all clean
  ...
  (**<!-- count:matrix-cases -->211<!-- /count -->** cases); `./setup`
...
- Roadmap runs to 32 skills after the fold rulings (26 built, wave 5's
  ...
  **<!-- count:open-scheduled -->38<!-- /count --> scheduled
...
later". README is <!-- count:readme-lines -->509<!-- /count --> lines,
