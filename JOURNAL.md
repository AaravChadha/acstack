...
- Working tree clean; `scripts/check.sh` all clean
  ...
  (**<!-- count:matrix-cases -->152<!-- /count -->** cases); `./setup`
...
- Roadmap runs to 32 skills after the fold rulings (25 built, wave 5's
  ...
  **<!-- count:open-scheduled -->20<!-- /count --> scheduled
  ...
  **<!-- count:wave45-open -->2<!-- /count -->**) → 5 (7) → 6
...
| 5 / 6 / 7 — Gates, review board, operate | 🔶 7/14 (wave 5) | /contract-check and /deps review shipped 2026-08-17, /deps upgrade 2026-09-10; 5.11 gave the matrix a case filter the same day, so a targeted run costs ~1 min against a full run measured three times the same day on the same machine at **16m26s, 28m21s and 30m15s** (~6.6 to ~11.9 s/case — load-dependent, so the range is the fact and no single sample is); 5.13/5.14 filed 2026-09-10 from a host-namespace recheck; 5.7 ruled the cap 12,000 → 13,500 (2026-09-08). Remaining roadmap after the fold rulings is **7 skills, not 16**: /careful, /verify, /board (6.1–6.5 as lenses), /skill, /operate (7.1+7.2), /document, /cost |
