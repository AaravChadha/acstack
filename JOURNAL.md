...
- Working tree clean; `scripts/check.sh` all clean
  ...
  (**<!-- count:matrix-cases -->117<!-- /count -->** cases); `./setup`
...
- Roadmap runs to 39 skills (those built, plus wave 5's 5, wave 6's 7 and
  wave 7's 4), **<!-- count:open-scheduled -->27<!-- /count --> scheduled
  ...
  **<!-- count:wave45-open -->11<!-- /count -->**) → 5 (5) → 6
